...
import "./App.css";
import l1_fh_img from "./assets/l1_fh_img.png"; //fh stands for first-half
import l1_sh_img1 from "./assets/l1_sh_img1.png"; //sh stands for second-half
import l1_sh_img2 from "./assets/l1_sh_img2.png";
import l2shimg1 from "./assets/l2shimg1.png";
import l2shimg2 from "./assets/l2shimg2.png";
import l3shimg1 from "./assets/l3shimg1.png";
import l3shimg2 from "./assets/l3shimg2.png";
import l4shimg1 from "./assets/l4shimg1.png";
import l4shimg2 from "./assets/l4shimg2.png";
import l4shimgpizza from "./assets/l4shimgpizza.png";
import l4shimgroll from "./assets/l4shimgroll.png";
import l4shimgbun from "./assets/l4shimgbun.png";
import l5shimg1 from "./assets/l5shimg1.png";
import l5shimg2 from "./assets/l5shimg2.png";
import l5shimg3 from "./assets/l5shimg3.png";
import l5shimg4 from "./assets/l5shimg4.png";
import l5shimg5 from "./assets/l5shimg5.png";
import l6shimg from "./assets/l6shimg.png";
import l7fhimg from "./assets/l7fhimg.png";
import l7shimg1 from "./assets/l7shimg1.png";
import l7shimg2 from "./assets/l7shimg2.png";
...
const App = () => {
  const [first_half_layer, setFirst_half_layer] = useState("fhl1"); //fhl1-->first-half layer-1
  const [second_half_layer, setSecond_half_layer] = useState("shl1"); //shl1-->Second-half layer-1
      ...
      {breaking_point_desktop ? (
        <div className="screen">
          ...
          <div id={first_half_layer} className="firsthalf">
                ...
                <g id="Dots1" className="dots-nav">
                  <g>
                    <path
                      ...
                      className={
                        top_p_text[8] > 1 ? "progressdelay" : "normaldots"
                      }
                  ...
                  <g>
                    <path
                      class="dotsstro1"
                      className={
                        top_p_text[8] > 1 ? "progressdelay2" : "normaldots2"
                      }
                      style={{
                        fill: "none",
                        stroke: "rgb(255, 255, 255)",
                ...
                <g id="Dots2" className="dots-nav">
                  <g>
                    <path
                      ...
                      className={
                        top_p_text[8] > 2 ? "progressdelay" : "normaldots"
                      }
                  ...
                  <g>
                    <path
                      class="dotsstro2"
                      className={
                        top_p_text[8] > 2 ? "progressdelay2" : "normaldots2"
                      }
                      style={{
                        fill: "none",
                        stroke: "rgb(255, 255, 255)",
                ...
                <g id="Dots3" className="dots-nav">
                  <g>
                    <path
                      ...
                      className={
                        top_p_text[8] > 3 ? "progressdelay" : "normaldots"
                      }
                  ...
                  <g>
                    <path
                      class="dotsstro3"
                      className={
                        top_p_text[8] > 3 ? "progressdelay2" : "normaldots2"
                      }
                      style={{
                        fill: "none",
                        stroke: "rgb(255, 255, 255)",
                ...
                <g id="Dots4" className="dots-nav">
                  <g>
                    <path
                      ...
                      className={
                        top_p_text[8] > 4 ? "progressdelay" : "normaldots"
                      }
                  ...
                  <g>
                    <path
                      class="dotsstro4"
                      className={
                        top_p_text[8] > 4 ? "progressdelay2" : "normaldots2"
                      }
                      style={{
                        fill: "none",
                        stroke: "rgb(255, 255, 255)",
                ...
                <g id="Dots5" className="dots-nav">
                  <g>
                    <path
                      ...
                      className={
                        top_p_text[8] > 5 ? "progressdelay" : "normaldots"
                      }
                  ...
                  <g>
                    <path
                      class="dotsstro5"
                      className={
                        top_p_text[8] > 5 ? "progressdelay2" : "normaldots2"
                      }
                      style={{
                        fill: "none",
                        stroke: "rgb(255, 255, 255)",
                ...
                <g id="Dots6" className="dots-nav">
                  <g>
                    <path
                      ...
                      className={
                        top_p_text[8] > 6 ? "progressdelay" : "normaldots"
                      }
                  ...
                  <g>
                    <path
                      class="dotsstro6"
                      className={
                        top_p_text[8] > 6 ? "progressdelay2" : "normaldots2"
                      }
                      style={{
                        fill: "none",
                        stroke: "rgb(255, 255, 255)",
            ...
            <img
              className={top_p_text[3] === "ABC 123" ? "fadein" : "fadeout"}
              style={{ width: "300px", marginLeft: "10%", marginTop: "50vh" }}
              alt="img"
              src={l1_fh_img}
            />
            <img
              className={top_p_text[3] === "ABC 412" ? "fadein" : "fadeout"}
          ...
          <div id={second_half_layer} className="secondhalf">
            <img
              className={
                top_p_text[3] === "ABC 123" ? "l1sheffectin" : "l1sheffectout"
              }
            ...
            <img
              className={
                top_p_text[3] === "ABC 567"
                  ? "l5shimg1effectin"
                  : "l5shimg1effectout"
              }
              style={{ marginLeft: "190px", position: "absolute" }}
              alt="mobile img 1"
              src={l5shimg1}
            />
            <img
            ...
            <img
              className={
                top_p_text[3] === "ABC 678"
                  ? "l6shimgeffectin"
                  : "l6shimgeffectout"
              }
              style={{ position: "absolute", width: "100%", height: "900px" }}
              alt="mobile img 1"
              src={l6shimg}
            />
            <img
              className={
                top_p_text[3] === "ABC 412"
                  ? "l7shimg2effectin"
                  : "l7shimg2effectout"
              }
